...
<!----------------------------------------------------------------------------------->
    ...
    <div class="row">
    	<div class="col-md-12 mb-3 stretch-card pl-0 mb-5">
    		<div class="card">
    			<div class="card-body">
    				<div class="row text-center">
    					<div class="form-group col-lg-12 mb-2">
    						<h3 class="font-weight-bold text-white text-center mb-4">Confirm Your Availability For The Session</h3>
    					    <p class="text-white text-center">Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the industry's standard dummy text ever since the 1500s, when an unknown printer took a galley of type and scrambled it to make a</p>	
    					</div>
    				    <div class="text-center w-100">
    				        <img src="{{ URL::asset('assets/media/availability.png') }}" class="pay-gif">
    				    </div>
    					<table id="order-table" class="table mx-5" style="width:100%">
    
                            <thead style="background: #ff9a7a36;">
    		...
    		<div class="card">
    			<div class="card-body">
                   ...
                   <form action="{{route('coach-booking-rejection' )}}"  method="post">
    				...
    				<div class="row">
    					<div class="form-group col-lg-12 mb-2">
    						<h3 class="font-weight-bold text-white text-capitalize text-center mb-4">reject this meeting</h3> 
    						<p class="text-white text-center mb-4">Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the industry's standard dummy text ever since the 1500s, when an unknown printer took a galley of type and scrambled it to make a</p>	
    					</div>
    					<div class="form-group col-8 m-auto mb-5">
    			...
    			<div class="card-body">
    				<div class="row">
    					<div class="form-group col-lg-12 mb-5">
    						<h3 class="font-weight-bold text-white text-center mb-4">Wait for user Confirmation with payment</h3>
    					    <p class="text-white text-center">Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the industry's standard dummy text ever since the 1500s, when an unknown printer took a galley of type and scrambled it to make a</p>	
    					</div>
    					<div class="form-group col-lg-12 mb-3">
    						<h5 class="text-white after-line position-relative">Thanks for confirm your availability</h5>
    					</div>
