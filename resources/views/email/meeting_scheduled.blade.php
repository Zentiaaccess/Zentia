        ...
        <tbody>
            ...
            <tr>
             ...
             <tr>
              ...
              <tr>
                <td style="display: block;text-align: center;padding: 28px 0 14px 0;color: #ffffff;max-width: 452px;margin: auto;font-size: 16px;line-height: 24px;">1. Login to your <strong>Zentia profile</strong></td>
             </tr>
              <tr>
                <td style="display: block;text-align: center;padding: 28px 0 14px 0;color: #ffffff;max-width: 452px;margin: auto;font-size: 16px;line-height: 24px;">2. Click the <strong>‘Join Meeting’</strong> section, in the side panel</td>
             </tr>
              <tr>
                <td style="display: block;text-align: center;padding: 28px 0 14px 0;color: #ffffff;max-width: 452px;margin: auto;font-size: 16px;line-height: 24px;">3. You’re now ready! 💯</td>
             </tr>
              <tr>
                <td style="display: block;text-align: center;padding: 28px 0 14px 0;color: #ffffff;max-width: 452px;margin: auto;font-size: 16px;line-height: 24px;">4. In case you wish to extend the meeting, while having it, there’s an option for that as well in the call</td>
             </tr>
              <tr>
