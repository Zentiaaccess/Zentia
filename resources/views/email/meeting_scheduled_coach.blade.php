    ...
    <table style="width: 100%;max-width: 700px; margin: 30px auto;background-color: #000;border-top: 5px solid #ff9b7b;border-radius: 4px;font-family: Arial, Helvetica, sans-serif;position: relative;box-shadow: rgba(149, 157, 165, 0.2) 0px 8px 24px;" cellpadding="0" cellspacing="0">
        <tbody>
            ...
            <tr>
             ...
             <tr>
                <td style="display: block;text-align: center;padding: 28px 0 14px 0;color: #ffffff;max-width: 452px;margin: auto;font-size: 16px;line-height: 24px;">Exciting times ahead! 🚀 Your meeting with x is now confirmed, paid and scheduled.</td>
             </tr>
             <tr>
                <td style="display: block;text-align: center;padding: 28px 0 14px 0;color: #ffffff;max-width: 452px;margin: auto;font-size: 16px;line-height: 24px;">1. The <strong>meeting will take place on Zentia.io</strong> - we recommend logging in a few minutes early</td>
             </tr>
             <tr>
                <td style="display: block;text-align: center;padding: 28px 0 14px 0;color: #ffffff;max-width: 452px;margin: auto;font-size: 16px;line-height: 24px;">2. To join the meeting: Go to your Dashboard overview, click the <strong>‘Join Meeting’</strong> section, in the side panel</td>
             </tr>
             <tr>
                <td style="display: block;text-align: center;padding: 28px 0 14px 0;color: #ffffff;max-width: 452px;margin: auto;font-size: 16px;line-height: 24px;">3. If you or the other person wish to, you have the option to extend the session 20 min., 40 min. or 60 min., during the meeting. (The user will be charged immediately for the extra time and you will receive the payment asap after the session).</td>
             </tr>
             <tr>
