  ...
  <body id="chat-pag">
    <div class="content-wrapper">
      <div class="row">
        <div class="col-md-12 grid-margin">
          <div class="d-flex justify-content-between aling-items-center">
                ...
                <div class="timer-heading">
                    <h4 class="text-white">Your meeting will be expired at</h4>
        ...
        <div class="col-md-9 grid-margin w-100">
          <div class="card">
        ...
        <div class="col-md-3 grid-margin stretch-card">
          <div class="card">
            <div class="card-body">
              <div class="row px-2">
                <h3 class="font-weight-bold text-white">Extend Meaning </h3>
                <p class="font-weight-normal mb-0 text-white">Lorem Ipsum is simply dummy text of the printing and typesetting industry.</p>
                  ...
                  <div class="form-group ml-2 w-100">
                    <div class="form-check">
                      <label class="form-check-label">
                        <input type="radio" class="form-check-input" name="preferred_session" value="{{ $coach->price_20 }}/20"> 20 Minutes </label>
                    </div>
                    <div class="form-check">
                      <label class="form-check-label">
                        <input type="radio" class="form-check-input" name="preferred_session" value="{{ $coach->price_40 }}/40"> 40 Minutes </label>
                    </div>
                    <div class="form-check">
                      <label class="form-check-label">
                        <input type="radio" class="form-check-input" name="preferred_session" value="{{ $coach->price_60 }}/60"> 60 Minutes </label>
                    </div>
                    <div class="form-group ml-2 mt-3">
                      <button type="submit" class="btn btn-success btn-icon-text btn-block" >
                        <i class="ti-video-camera btn-icon-prepend"></i> Extend </button>
                    </div>
                  </div>
                </form>
              </div>
