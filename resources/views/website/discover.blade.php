...
@section('content')    
    ...
    <section class="categories-section py-5">
        <div class="container">
            <p class="profile-heading text-white roboto mb-4">Industry</p>
            <div class="profile-time-slot category-slots mb-4 mb-sm-5">
              
                @foreach ($Industry as $IndustryList)
                <div class="time-select check-cl">
                    <label>
                        <input type="checkbox" name="industry[]" value="{{ $IndustryList->id }}" class="ajaxfilter industrycheckbox"><span class="text-white exo">{{ $IndustryList->name }}{{ $IndustryList->id }}</span>
                    </label>
                </div>
            ...
            <p class="profile-heading text-white roboto mb-4">Expertise</p>
            <div class="profile-time-slot category-slots mb-4 mb-sm-5">
               
                @foreach ($Expertise as $ExpertiseList)
                <div class="time-select check-cl">
                    <label>
                        <input type="checkbox" name="expertise[]" value="{{ $ExpertiseList->id }}" class="ajaxfilter expertisecheckbox"><span class="text-white exo">{{ $ExpertiseList->name }}{{ $ExpertiseList->id }}</span>
                    </label>
                </div>
            ...
            <p class="profile-heading text-white roboto mb-4">Business Models</p>
            <div class="profile-time-slot category-slots">
                
                
                @foreach ($Business as $BusinessList)
                <div class="time-select check-cl">
                    <label>
                        <input type="checkbox" name="business_models[]" value="{{ $BusinessList->id }}" class="ajaxfilter business_modelscheckbox"><span class="text-white exo">{{ $BusinessList->name }}{{ $BusinessList->id }}</span>
                    </label>
                </div>
