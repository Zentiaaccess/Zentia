            ...
            <div class="header-wrap">
                <nav class="head-nav exo">
                    <ul class="nav-ul">
                        ...
                        @endphp
                            <li class="nav-li">
                                <a href="{{ route('become-an-advisor') }}" class="nav-items">Become an Advisor</a>
                            </li>
                        @php
                            }
                        }else{
                        ...
                        @endphp 
                        <li class="nav-li d-block d-md-none">
                                    ...
                                    @if (Route::has('login'))
                                            ...
                                            @auth
                                                ...
                                                @endphp
                                                    ...
                                                    <a href="{{ route('user-dashboard') }}" class="text-capitalize d-block button-primary border-0 fs-14">
                                                        <span><i class="fa fa-user-o me-2" aria-hidden="true"></i>Dashboard</span>
                                                    </a>
                ...
                <div class="header-signup-dropmenu d-none d-md-block"> 
                    <div class="dropdown">
                        ...
                        @if (Route::has('login'))
                                ...
                                @else
                                    ...
                                    @if (Route::has('register'))
                                        <button type="button" class="text-capitalize button-primary border-0 fs-14" data-bs-toggle="dropdown">
                                            <span><i class="fa fa-user-o me-2" aria-hidden="true"></i>sign up/login</span>
                                        </button>
                                        <ul class="dropdown-menu p-0 bg-transparent signup-drop-menu">
                                          <li>
