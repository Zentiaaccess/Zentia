            ...
            <div class="row">
                <div class="col-md-4 pe-4 pe-sm-5 position-relative mb-5 mb-sm-0 d-flex">
                   ...
                   <div class="work-card-wrap text-center py-5 px-3">
                        ...
                        <h2 class="text-main roboto mb-4">Giving Back</h2>
                ...
                <div class="col-md-4 pe-4 pe-sm-5 position-relative mb-5 mb-sm-0 d-flex">
                    ...
                    <div class="work-card-wrap text-center py-5 px-3">
                        ...
                        <h2 class="text-main roboto mb-4">Earn Money</h2>
                ...
                <div class="col-md-4 pe-4 pe-sm-5 position-relative d-flex">
                 <div class="how-it-word-overlay"></div>
                     <div class="work-card-wrap text-center py-5 px-3">
                         ...
                         <h2 class="text-main roboto mb-4">Stay Up to Date</h2>
                        ...
                        <div class="container">
                            <div class="row">
                                <div class="col-md-6 ps-sm-5">
                                    ...
                                    <p class="text-white fs-22 mb-5">Co-founder of Digital Ocean, CEO, Investor</p>
                                    <p class="text-white mb-4 fs-22">"I still remember what it's like being on the other side of the table - where a solid piece of advice could literally change everything.</p>
                                    <p class="text-white mb-4 fs-22">I think it's all about surrounding yourself with people who can bring a different perspective to your journey and the challenges you're facing.</p>
                                    <p class="text-white mb-4 fs-22">For me to be able to help and guide other passionate, upcoming entrepreneurs today, truly brings me energy and joy. "</p>
                                </div>
                        ...
                        <div class="container">
                            <div class="row">
                                <div class="col-md-6 ps-sm-5">
                                    ...
                                    <p class="text-white fs-22 mb-5">Founder, CMO, Advisor</p>
                                    <p class="text-white mb-4 fs-22">“I truly enjoy talking to passionate people from all over the world, who are super driven when it comes to building their business and career, and I love to pitch in with ideas and perspectives, and help them overcome whatever challenges they might be facing.</p>
                                    <p class="text-white mb-4 fs-22">I’ve spent millions of dollars on marketing strategies and campaigns over the years, spanning from big TV and branding campaigns to tactical digital performance based initiatives in both B2B and B2C tech scaleups. </p>
                                    <p class="text-white mb-4 fs-22">I would love to help others skip all the costly mistakes I’ve made in the past, and instead jump straight to what actually works in marketing."</p>
                                </div>
                                <div class="col-md-6 pe-5">
